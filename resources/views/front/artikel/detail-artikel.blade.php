            ...
            <div class="page-wrapper">
                <div class="blog-title-area">
                    ...
                    <span class="color-aqua"><a href="blog-category-01.html"
                            title="">{{ $artikel->kategori->nama_kategori }}</a></span>

                    <h3>{{ $artikel->judul }}</h3>

                    <div class="blog-meta big-meta">
                        <small><a href="single.html" title="">{{ $artikel->created_at }}</a></small>
                        <small><a href="blog-author.html" title="">by {{ $artikel->users->name }}</a></small>
                        <small><a href="#" title=""><i class="fa fa-eye"></i> {{ $artikel->viewers }}</a></small>
                    </div><!-- end meta -->
                ...
                <div class="blog-title-area">
                    <div class="tag-cloud-single">
                        <span>Tags</span>
                        <small><a href="#" title="">{{ $artikel->kategori->nama_kategori }}</a></small>
                    </div><!-- end meta -->
                    ...
                    <div class="col-lg-12">
                        <div class="banner-spot clearfix">
                            <div class="banner-img">
                                <img src="{{asset('front/upload/banner_01.jpg')}}" alt="" class="img-fluid">
                            </div><!-- end banner-img -->
                        </div><!-- end banner -->
                    </div><!-- end col -->
                </div><!-- end row -->
                                ...
                                <div class="list-group">
                                    <a href="single.html"
                                        ...
                                        <div class="w-100 justify-content-between">
                                            ...
                                            <h5 class="mb-1">Let's make an introduction to the glorious world of history
                                            </h5>
                            ...
                            <div class="comments-list">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading user_name">Amanda Martines <small>5 days ago</small>
                                        </h4>
                                ...
                                <div class="media last-child">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>Kickstarter seitan retro. Drinking vinegar stumptown yr pop-up artisan sunt.
