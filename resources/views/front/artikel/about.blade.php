        ...
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
            <div class="page-wrapper">
                ...
                <div class="single-post-media">
                    <img src="{{ asset('front/images/about.jpg') }}" alt="Clark Tibbs - Unplash" class="img-fluid">
                </div><!-- end media -->
                ...
                <div class="blog-content">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus animi laborum odit provident officiis, aperiam voluptate non commodi doloribus sequi voluptas quo, accusamus, pariatur culpa ut numquam vel tempore iste.
                </div><!-- end content -->
