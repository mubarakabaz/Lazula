                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="#">Tabel Sensor Suhu</a>
                            </li>
                            <li class="submenu-item"><a class="submenu-link" href="#">Tabel Sensor PH</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="#">Tabel Sensor TDS</a></li>
                            <!-- Pompa -->
                            <li class="submenu-item"><a class="submenu-link" href="#">Tabel Pompa Nutrisi</a></li>
                        </ul>
                    </div>
                </li>
                <!--//nav-item-->
